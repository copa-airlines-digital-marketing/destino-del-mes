    ...
    var t = "data-add-functionalities",
        ...
        Z = function (n) {
            return function (t) {
                ...
                if ("null" === r) return !0;
                var u = A(n, e);
                return u || console.warn("fare item doesn't containts attribute " + e +
                    " or it's value is null", n), r === u
            }
        },
        $ = function (n, t) {
            return n && t
        ...
        rn = function (n) {
            if (null === n) return !1;
            var t = null !== I(n);
            return t || console.warn("Filter found does not have " + u + " attribute. Ignoring this filter", n),
                t
        },
        en = function (n) {
            return function (t) {
        ...
        on = function (n) {
            ...
            if (e) {
                var u = JSON.parse(e);
                t = u.map(h).filter(rn), u.length > t.length && console.warn(
                    "Some filters were not found by their IDs:", u, "Filters found", t)
            }
            var i = L(n);
            if (i && (r = h(i), !r)) return console.error("Looked for element with id " + i +
                " but none found");
            var o = un(n, t, r);
